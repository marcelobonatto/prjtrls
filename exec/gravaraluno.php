...
if (!isset($_POST['email'])) $mensagem[] = 'E-mail n&atilde;o informada'; else $escola = $_POST['email'];
if (!isset($_POST['ano'])) $mensagem[] = 'Ano n&atilde;o informadao'; else $ano = $_POST['ano'];
