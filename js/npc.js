$(document).ready(function() {
    ...
    function submitForm() {
        ...
        var imagemNormal = $("#txtImgNormal").val();
        var icone = $("#txtIcone").val();
        var ativo = $("input[name='optAtivo']:checked").val();

        $.ajax({
            type: "POST",
            url: "exec/gravarnpc.php",
            data: "id=" + id + "&nome=" + nome + "&chave=" + chave + "&eixo=" + eixo + "&imagemNormal=" + imagemNormal + "&icone=" + icone + "&ativo=" + ativo,
